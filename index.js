...
const URL =
  "mongodb+srv://vishnu:n3Uf35jUEa!4qEr@cluster0.xfblp.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
    ...
    db.collection("urls").findOne(
      ...
      function (err, data) {
        if (err) {
          ...
          if (data !== null) res.redirect(data.longurl);
          else
            res.json({
...
app.delete("/:id", async function (req, res) {
    try {
      ...
      let answer = await db.collection("urls").deleteOne({_id:mongodb.ObjectID(req.params.id)});
